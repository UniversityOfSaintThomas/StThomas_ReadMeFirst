...
(NOTE: This is very close to GitHub's instructions for adding [outside collaborators](https://help.github.com/en/github/setting-up-and-managing-organizations-and-teams/adding-outside-collaborators-to-repositories-in-your-organization) to a repository. GitHub suggests a [different method](https://help.github.com/en/github/setting-up-and-managing-organizations-and-teams/managing-team-access-to-an-organization-repository#giving-a-team-access-to-a-repository) for adding teams, but this method, in many cases, _does not work_ and should be disregarded.)
